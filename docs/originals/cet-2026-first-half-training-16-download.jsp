...
<head>
    ...
    <script>
        ...
        function setCode()
        {
            ...
            window.location.href = "/system/_content/download.jsp?urltype=news.DownloadAttachUrl&owner=1803104057&wbfileid=4ECC0CDDDA3A8C310B9F60A84D6E973A&codeValue="+codeValue;
        }
    </script>
    <style type="text/css">
        body {
