...
<head>
    ...
    <script>
        ...
        function setCode()
        {
            ...
            window.location.href = "/system/_content/download.jsp?urltype=news.DownloadAttachUrl&owner=1803104057&wbfileid=ED7ADC99935D98D1DBFFDBD26AF2D6BB&codeValue="+codeValue;
        }
    </script>
    <style type="text/css">
        body {
