...
<head>
    ...
    <script>
        ...
        function setCode()
        {
            ...
            window.location.href = "/system/_content/download.jsp?urltype=news.DownloadAttachUrl&owner=1803104057&wbfileid=4D31C5B4A9369632DAC827B3B27F59AC&codeValue="+codeValue;
        }
    </script>
    <style type="text/css">
        body {
