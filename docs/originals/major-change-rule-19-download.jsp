...
<head>
    ...
    <script>
        ...
        function setCode()
        {
            ...
            window.location.href = "/system/_content/download.jsp?urltype=news.DownloadAttachUrl&owner=1803104057&wbfileid=10433F616A339818DA57394EDE52AA46&codeValue="+codeValue;
        }
    </script>
    <style type="text/css">
        body {
