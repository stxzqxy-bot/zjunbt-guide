...
<head>
    ...
    <script>
        ...
        function setCode()
        {
            ...
            window.location.href = "/system/_content/download.jsp?urltype=news.DownloadAttachUrl&owner=1803104057&wbfileid=6B35CF69DBE994995184D33871E1E208&codeValue="+codeValue;
        }
    </script>
    <style type="text/css">
        body {
